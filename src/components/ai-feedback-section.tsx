...
export function AiFeedbackSection({
  ...
  async function handleGenerate() {
    setLoading(true);
    try {
      const res = await fetch(`/api/recordings/${recordingId}/ai-feedback`, {
        method: "POST",
      });
        ...
        {feedback ? (
          ...
          <div className="space-y-2">
            <p className="text-sm text-muted-foreground">
              Get an AI-generated rating and pointers on tempo, dynamics, and consistency —
              based on watching this take. This can take up to a minute.
            </p>
