...
export default async function PublicRecordingDetailPage({
  params,
}: {
  ...
  const pieceHref = `/visitor/piece?title=${encodeURIComponent(recording.title)}&composer=${encodeURIComponent(
    recording.composer
  )}`;
  ...
  return (
    <div className="mx-auto max-w-4xl space-y-6 px-4 py-8">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <RecordingActions id={recording.id} isFavorite={recording.isFavorite} role="visitor" />
      </div>
